...
**Mentions:** When there is a @ or # before the argument it means that you need to specify the arguments as a **mention**. `@` means that you need to specify a **user mention** and `#` a **channel mention**
